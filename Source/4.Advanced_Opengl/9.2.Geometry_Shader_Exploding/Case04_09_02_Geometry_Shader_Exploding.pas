unit Case04_09_02_Geometry_Shader_Exploding;
...
procedure Main;
const
  vs = '..\Source\4.Advanced_Opengl\9.2.Geometry_Shader_Exploding\9.2.geometry_shader.vs';
  fs = '..\Source\4.Advanced_Opengl\9.2.Geometry_Shader_Exploding\9.2.geometry_shader.fs';
  gs = '..\Source\4.Advanced_Opengl\9.2.Geometry_Shader_Exploding\9.2.geometry_shader.gs';
  model_nanosuit = '..\Resources\objects\nanosuit\nanosuit.obj';
var
  window: PGLFWwindow;
...
begin
  ...
  nanosuit := TModel.Create(model_nanosuit);
