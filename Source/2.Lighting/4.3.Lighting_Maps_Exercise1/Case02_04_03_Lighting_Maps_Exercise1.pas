unit Case02_04_03_Lighting_Maps_Exercise1;
...
procedure Main;
const
  fs = '..\Source\2.Lighting\4.3.Lighting_Maps_Exercise1\4.3.lighting_maps.fs';
  vs = '..\Source\2.Lighting\4.3.Lighting_Maps_Exercise1\4.3.lighting_maps.vs';
  light_cube_fs = '..\Source\2.Lighting\4.3.Lighting_Maps_Exercise1\4.3.light_cube.fs';
  light_cube_vs = '..\Source\2.Lighting\4.3.Lighting_Maps_Exercise1\4.3.light_cube.vs';
...
begin
  ...
  try
    ...
    begin
      ...
      lightingShader.SetUniformFloat('light.ambient', [0.9, 0.9, 0.9]);
      lightingShader.SetUniformFloat('light.diffuse', [0.9, 0.9, 0.9]);
