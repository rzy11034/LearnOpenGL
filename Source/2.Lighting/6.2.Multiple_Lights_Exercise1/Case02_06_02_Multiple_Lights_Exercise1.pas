...
var
  ...
  begin
    ...
    begin
      ...
      lightingShader.SetUniformVec3(uniformStr, pointLightColor * 0.1);

      uniformStr := UnicodeFormat('pointLights[%d].diffuse', [i]);
      lightingShader.SetUniformVec3(uniformStr, pointLightColor);
    ...
    begin
      ...
      lightCubeShader.SetUniformVec3('ourColor', pointLightColors[i]);
      glDrawArrays(GL_TRIANGLES, 0, 36);
    end;
  end;
