...
procedure Main;
const
  fs = '..\Source\2.Lighting\6.2.Multiple_Lights_Exercise1\6.2.multiple_lights.fs';
  vs = '..\Source\2.Lighting\6.2.Multiple_Lights_Exercise1\6.2.multiple_lights.vs';
  light_cube_fs = '..\Source\2.Lighting\6.2.Multiple_Lights_Exercise1\6.2.light_cube.fs';
  light_cube_vs = '..\Source\2.Lighting\6.2.Multiple_Lights_Exercise1\6.2.light_cube.vs';
...
var
  ...
  cubePositions, pointLightPositions, pointLightColors: TArr_TVec3;
  uniformStr: string;
  pointLightColor: TVec3;

  procedure __Desert__;
  var
    i: integer;
  begin
    // render
    ...
    pointLightColors := TArr_TVec3([
      TGLM.Vec3(0.1, 0.6, 0.0),
      TGLM.Vec3(1.0, 0.0, 0.0),
      TGLM.Vec3(1.0, 1.0, 0.0),
      TGLM.Vec3(0.2, 0.2, 1.0)]);
    ...
    lightingShader.SetUniformFloat('dirLight.ambient', [0.3, 0.24, 0.14]);
    lightingShader.SetUniformFloat('dirLight.diffuse', [0.7, 0.42, 0.26]);
    lightingShader.SetUniformFloat('dirLight.specular', [0.5, 0.5, 0.5]);

    // point light
    for i := 0 to 3 do
    begin
      pointLightColor := pointLightColors[i];
      ...
      lightingShader.SetUniformFloat(uniformStr, pointLightColor * 0.1);

      uniformStr := UnicodeFormat('pointLights[%d].diffuse', [i]);
      lightingShader.SetUniformFloat(uniformStr, pointLightColor);
    ...
    lightingShader.SetUniformFloat('spotLight.diffuse', [0.8, 0.8, 0.0]);
    lightingShader.SetUniformFloat('spotLight.specular', [0.8, 0.8, 0.0]);
    ...
    lightingShader.SetUniformFloat('spotLight.outerCutOff', [Cos(TGLM.Radians(13.0))]);
    ...
    begin
      ...
      lightCubeShader.SetUniformFloat('ourColor', pointLightColors[i]);
      glDrawArrays(GL_TRIANGLES, 0, 36);
    end;
  end;

  procedure __Factory__;
  var
    i: integer;
  begin
    // render
    ...
    pointLightColors := TArr_TVec3([
      TGLM.Vec3(0.2, 0.2, 0.6),
      TGLM.Vec3(0.3, 0.3, 0.7),
      TGLM.Vec3(0.0, 0.0, 0.3),
      TGLM.Vec3(0.4, 0.4, 0.4)]);
    ...
    // directional light
    lightingShader.SetUniformFloat('dirLight.direction', [-0.2, -1.0, -0.3]);
    lightingShader.SetUniformFloat('dirLight.ambient', [0.05, 0.05, 0.1]);
    lightingShader.SetUniformFloat('dirLight.diffuse', [0.2, 0.2, 0.7]);
    lightingShader.SetUniformFloat('dirLight.specular', [0.7, 0.7, 0.7]);
    ...
    lightingShader.SetUniformFloat('spotLight.linear', [0.09]);
    lightingShader.SetUniformFloat('spotLight.quadratic', [0.032]);
    lightingShader.SetUniformFloat('spotLight.cutOff', [Cos(TGLM.Radians(10.0))]);
    lightingShader.SetUniformFloat('spotLight.outerCutOff', [Cos(TGLM.Radians(12.5))]);
  ...
  begin
    ...
    pointLightColors := TArr_TVec3([
      TGLM.Vec3(0.1, 0.1, 0.1),
      TGLM.Vec3(0.1, 0.1, 0.1),
      TGLM.Vec3(0.1, 0.1, 0.1),
      TGLM.Vec3(0.3, 0.1, 0.1)]);
    ...
    // directional light
    lightingShader.SetUniformFloat('dirLight.direction', [-0.2, -1.0, -0.3]);
    lightingShader.SetUniformFloat('dirLight.ambient', [0.0, 0.0, 0.0]);
    lightingShader.SetUniformFloat('dirLight.diffuse', [0.05, 0.05, 0.05]);
    lightingShader.SetUniformFloat('dirLight.specular', [0.2, 0.2, 0.2]);
    ...
    begin
      ...
      uniformStr := UnicodeFormat('pointLights[%d].linear', [i]);
      lightingShader.SetUniformFloat(uniformStr, [0.14]);

      uniformStr := UnicodeFormat('pointLights[%d].quadratic', [i]);
      lightingShader.SetUniformFloat(uniformStr, [0.7]);
    end;
  ...
  begin
    ...
    // directional light
    lightingShader.SetUniformFloat('dirLight.direction', [-0.2, -1.0, -0.3]);
    lightingShader.SetUniformFloat('dirLight.ambient', [0.5, 0.5, 0.5]);
    lightingShader.SetUniformFloat('dirLight.diffuse', [1.0, 1.0, 1.0]);
    lightingShader.SetUniformFloat('dirLight.specular', [1.0, 1.0, 1.0]);
    ...
    begin
      ...
      uniformStr := UnicodeFormat('pointLights[%d].linear', [i]);
      lightingShader.SetUniformFloat(uniformStr, [0.07]);

      uniformStr := UnicodeFormat('pointLights[%d].quadratic', [i]);
      lightingShader.SetUniformFloat(uniformStr, [0.017]);
    end;
    ...
    lightingShader.SetUniformFloat('spotLight.direction', camera.Front);
    lightingShader.SetUniformFloat('spotLight.ambient', [0.0, 0.0, 0.0]);
    lightingShader.SetUniformFloat('spotLight.diffuse', [0.0, 1.0, 0.0]);
    lightingShader.SetUniformFloat('spotLight.specular', [0.0, 1.0, 0.0]);
    lightingShader.SetUniformFloat('spotLight.constant', [1.0]);
    lightingShader.SetUniformFloat('spotLight.linear', [0.07]);
    lightingShader.SetUniformFloat('spotLight.quadratic', [0.017]);
    lightingShader.SetUniformFloat('spotLight.cutOff', [Cos(TGLM.Radians(7.0))]);
    lightingShader.SetUniformFloat('spotLight.outerCutOff', [Cos(TGLM.Radians(10.0))]);
