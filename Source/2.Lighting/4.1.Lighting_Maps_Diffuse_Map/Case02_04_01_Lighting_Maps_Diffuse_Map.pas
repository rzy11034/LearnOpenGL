unit Case02_04_01_Lighting_Maps_Diffuse_Map;
...
// 加载漫反射贴图
function LoadDiffuseMap(fileName: string): cardinal; forward;
...
procedure Main;
const
  fs = '..\Source\2.Lighting\4.1.Lighting_Maps_Diffuse_Map\4.1.lighting_maps.fs';
  vs = '..\Source\2.Lighting\4.1.Lighting_Maps_Diffuse_Map\4.1.lighting_maps.vs';
  light_cube_fs = '..\Source\2.Lighting\4.1.Lighting_Maps_Diffuse_Map\4.1.light_cube.fs';
  light_cube_vs = '..\Source\2.Lighting\4.1.Lighting_Maps_Diffuse_Map\4.1.light_cube.vs';
  txName = '..\Resources\textures\container2.png';
var
  window: PGLFWwindow;
...
begin
  ...
  try
    ...
    diffuseMap := LoadDiffuseMap(txName);
    ...
    begin
      ...
      lightingShader.SetUniformFloat('material.shininess', [64.0]);
...
function LoadDiffuseMap(fileName: string): cardinal;
var
  txID: GLuint;
  tx: TTexture;
begin
