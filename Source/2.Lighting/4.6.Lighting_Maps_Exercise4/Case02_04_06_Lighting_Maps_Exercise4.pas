unit Case02_04_06_Lighting_Maps_Exercise4;
...
procedure Main;
const
  fs = '..\Source\2.Lighting\4.6.Lighting_Maps_Exercise4\4.6.lighting_maps.fs';
  vs = '..\Source\2.Lighting\4.2.Lighting_Maps_Specular_Map\4.2.lighting_maps.vs';
  light_cube_fs = '..\Source\2.Lighting\4.6.Lighting_Maps_Exercise4\4.6.light_cube.fs';
  light_cube_vs = '..\Source\2.Lighting\4.6.Lighting_Maps_Exercise4\4.6.light_cube.vs';
  diffuseTexture = '..\Resources\textures\container2.png';
  specularTexture = '..\Resources\textures\container2_specular.png';
  emissionTexture = '..\Resources\textures\matrix.jpg';
var
  window: PGLFWwindow;
  ...
  diffuseMap, specularMap, emissionMap: Cardinal;
begin
  window := InitWindows;
  if window = nil then
  begin
  ...
  try
    ...
    emissionMap := LoadTexture(emissionTexture);
