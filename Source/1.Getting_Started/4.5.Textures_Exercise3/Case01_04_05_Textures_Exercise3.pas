unit Case01_04_05_Textures_Exercise3;
...
begin
  ...
  // 创建一个窗口对象
  window := glfwCreateWindow(SCR_WIDTH, SCR_HEIGHT, 'LearnOpenGL'.ToPAnsiChar, nil, nil);
  if window = nil then
  begin
...
procedure Main;
const
  vs = '..\Source\1.Getting_Started\4.5.Textures_Exercise3\4.5.texture.vs';
  fs = '..\Source\1.Getting_Started\4.5.Textures_Exercise3\4.5.texture.fs';
...
begin
  ...
  try
    ...
    vertices := TArr_GLfloat([
      // ---位置---      ----颜色----     -纹理坐标-
       0.5,  0.5, 0.0,   1.0, 0.0, 0.0,   0.55, 0.55,   // 右上
       0.5, -0.5, 0.0,   0.0, 1.0, 0.0,   0.55, 0.45,  // 右下
      -0.5, -0.5, 0.0,   0.0, 0.0, 1.0,   0.45, 0.45,  // 左下
      -0.5,  0.5, 0.0,   1.0, 1.0, 0.0,   0.45, 0.55]); // 左上
