...
procedure Main;
const
  dir_path = '..\Source\5.Advanced_Lighting\5.1.Parallax_Mapping\';
  normal_mapping_vs = dir_path + '5.1.parallax_mapping.vs';
  normal_mapping_fs = dir_path + '5.1.parallax_mapping.fs';
