...
procedure Main;
const
  shader_path = '..\Source\5.Advanced_Lighting\5.3.Parallax_Occlusion_Mapping\';
  normal_mapping_vs = shader_path + '5.3.parallax_mapping.vs';
  normal_mapping_fs = shader_path + '5.3.parallax_mapping.fs';
